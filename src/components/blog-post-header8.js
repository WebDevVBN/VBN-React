            ...
            {props.blogPostTitle ?? (
              <Fragment>
                <span className="blog-post-header8-text2">
                  Simplify Your VA Disability Claims Process with Our Six-Step
                  Guide
                </span>
              </Fragment>
            )}
...
BlogPostHeader8.defaultProps = {
  blogPostImageAlt: 'VA Disability Claims Process',
  authorName: undefined,
  blogPostImageSrc:
    'https://images.unsplash.com/photo-1709294728718-91663cf5b318?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTc0NDI0NjE2N3w&ixlib=rb-4.0.3&q=80&w=1080',
